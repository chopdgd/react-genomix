...
describe('Test ExportButton', () => {
  it('ExportButton renders without crashing', () => {
    const div = document.createElement('div');
    ReactDOM.render(<ExportButton />, div);
  });

  it('ExportButton initial props are set correctly', () => {
  ...
  it('ExportButton props are set correctly', () => {
  ...
  it('ExportButton onExport is called w/ data onClick', () => {
    const onExport = jest.fn()
  ...
  it('ExportButton onExport is called and affects data', () => {
    const onExport = (data) => {
      const elements = []
      map(data, element => (
  ...
  it('ExportButton onExport is called and does not affect data', () => {
    const wrapper = mount(
      <ExportButton
        data={[{ test: 1, test2: 2 }]}
        content="Export Me"
