...
export const exacVariant = ( chr, pos, ref, alt ) =>
  `${urls.EXAC_URL}/variant/${chr}-${pos}-${ref}-${alt}`

export const gnomadVariant = ( chr, pos, ref, alt ) =>
...
export const orphanetEntry = id =>
  `${urls.ORPHANET_URL}/consor/cgi-bin/OC_Exp.php?Lng=EN&Expert=${id}`
