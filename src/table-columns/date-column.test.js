...
describe('Test DateColumn', () => {
  it('cellDataGetter returns expected content', () => {
    ...
    const dataKey = 'date'
    const element = <DateColumn label="test" dataKey={dataKey} width={100} />
  ...
  it('cellRenderer returns expected content', () => {
    ...
    const element = <DateColumn label="test" dataKey="test" width={100} columnData={columnData} />
    const wrapper = shallow(element)
    expect(
      wrapper
        .find('Column')
        .props()
        .cellRenderer({ cellData, columnData, rowIndex })
  ...
  it('headerRenderer returns expected content', () => {
    ...
    const element = <DateColumn label={label} dataKey="test" width={100} />
    const wrapper = shallow(element)
    expect(
      wrapper
        .find('Column')
