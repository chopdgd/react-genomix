...
import { TranscriptCell, TranscriptColumn } from '../index'
...
describe('Test TranscriptColumn', () => {
  it('cellDataGetter returns expected content', () => {
    ...
    const element = <TranscriptColumn label="test" dataKey={dataKey} width={100} />
  ...
  it('cellRenderer returns expected content', () => {
    ...
    const rowIndex = 1
    const element = <TranscriptColumn label="test" dataKey="test" width={100} />
    const wrapper = shallow(element)
    expect(
      wrapper
        .find('Column')
  ...
  it('headerRenderer returns expected content', () => {
    ...
    const element = <TranscriptColumn label={label} dataKey="test" width={100} />
    const wrapper = shallow(element)
    expect(
      wrapper
        .find('Column')
