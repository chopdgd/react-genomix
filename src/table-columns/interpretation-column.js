...
const cellRenderer = props => {
  ...
  return <InterpretationCell classification={cellData} rowIndex={rowIndex} labelProps={labelProps} />
}
...
class InterpretationColumn extends Column {
  static propTypes = {
    ...Column.propTypes,
...
export default InterpretationColumn
