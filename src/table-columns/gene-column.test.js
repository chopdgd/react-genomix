...
describe('Test GeneColumn', () => {
  it('cellDataGetter returns expected content', () => {
    ...
    const dataKey = 'gene'
    const element = <GeneColumn label="test" dataKey={dataKey} width={100} />
  ...
  it('cellRenderer returns expected content', () => {
    ...
    const rowIndex = 1
    const element = <GeneColumn label="test" dataKey="test" width={100} />
    const wrapper = shallow(element)
    expect(
      wrapper
        .find('Column')
  ...
  it('headerRenderer returns expected content', () => {
    ...
    const element = <GeneColumn label={label} dataKey="test" width={100} />
    const wrapper = shallow(element)
    expect(
      wrapper
        .find('Column')
