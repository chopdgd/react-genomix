...
describe('Test StatusFixedCell', () => {
  ...
  it('renders without crashing', () => {
    ...
    const element = <StatusFixedCell data={data} rowIndex={1} columnKey="status" />
    ReactDOM.render(element, div)
  })

  it('renders the pending status icon', () => {
    const element = <StatusFixedCell data={data} rowIndex={0} columnKey="status" />
  ...
  it('renders the complete status icon', () => {
    const element = <StatusFixedCell data={data} rowIndex={2} columnKey="status" />
    const wrapper = shallow(element)
  ...
  it('renders the cancelled status icon', () => {
    const element = <StatusFixedCell data={data} rowIndex={3} columnKey="status" />
    const wrapper = shallow(element)
  ...
  it('renders failed status icon', () => {
    const element = <StatusFixedCell data={data} rowIndex={4} columnKey="status" />
    const wrapper = shallow(element)
    expect(wrapper.props().children.props.color).toEqual('red')
  ...
  it('renders the unknown status icon', () => {
    const element = <StatusFixedCell data={data} rowIndex={5} columnKey="status" />
    const wrapper = shallow(element)
    expect(wrapper.props().children.props.color).toEqual('grey')
