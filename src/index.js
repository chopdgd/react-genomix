...
export { default as ClassificationCellRenderer } from './table-cell-renderers/classification-cell'
export { default as ConsequenceCellRenderer } from './table-cell-renderers/consequence-cell'
...
export { default as InterpretationCellRenderer } from './table-cell-renderers/interpretation-cell'
